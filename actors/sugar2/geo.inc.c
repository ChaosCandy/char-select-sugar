...
const GeoLayout sugar2_7_LoD_Switch__Unused__opt0_Cap_State_Switch_opt1[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_ANIMATED_PART(LAYER_OPAQUE, 7, 18, -10, NULL),
		GEO_OPEN_NODE(),
			GEO_ANIMATED_PART(LAYER_TRANSPARENT, 0, 5, 0, sugar2_Butt_mesh_layer_1),
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					GEO_ANIMATED_PART(LAYER_TRANSPARENT, 79, 0, 0, sugar2_Torso_mesh_layer_1),
					GEO_OPEN_NODE(),
					...
					GEO_CLOSE_NODE(),
				GEO_CLOSE_NODE(),
				GEO_ANIMATED_PART(LAYER_OPAQUE, 29, -3, 32, NULL),
				GEO_OPEN_NODE(),
					...
					GEO_CLOSE_NODE(),
				GEO_CLOSE_NODE(),
				GEO_ANIMATED_PART(LAYER_OPAQUE, 29, -4, -30, NULL),
				GEO_OPEN_NODE(),
...
const GeoLayout sugar2_7_LoD_Switch__Unused__opt0_Cap_State_Switch_opt2[] = {
	...
	GEO_OPEN_NODE(),
		GEO_ANIMATED_PART(LAYER_OPAQUE, 7, 18, -10, NULL),
		GEO_OPEN_NODE(),
			GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 5, 0, sugar2_Butt_mesh_layer_1_mat_override_Metal__CAP__0),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(LAYER_ALPHA, sugar2_Butt_mesh_layer_4_mat_override_Metal__CAP__0),
				GEO_ASM(0, geo_move_mario_part_from_parent),
				GEO_ROTATION_NODE(LAYER_FORCE, 0, 0, 0),
				GEO_OPEN_NODE(),
					GEO_ANIMATED_PART(LAYER_OPAQUE, 79, 0, 0, sugar2_Torso_mesh_layer_1_mat_override_Metal__CAP__0),
					GEO_OPEN_NODE(),
...
const GeoLayout sugar2_7_LoD_Switch__Unused__opt0_Cap_State_Switch_opt3[] = {
	...
	GEO_OPEN_NODE(),
		GEO_ANIMATED_PART(LAYER_OPAQUE, 7, 18, -10, NULL),
		GEO_OPEN_NODE(),
			GEO_ANIMATED_PART(LAYER_TRANSPARENT, 0, 5, 0, sugar2_Butt_mesh_layer_1_mat_override_Metal__CAP__1),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(LAYER_TRANSPARENT, sugar2_Butt_mesh_layer_4_mat_override_Metal__CAP__1),
				GEO_ASM(0, geo_move_mario_part_from_parent),
				GEO_ROTATION_NODE(LAYER_FORCE, 0, 0, 0),
				GEO_OPEN_NODE(),
					GEO_ANIMATED_PART(LAYER_TRANSPARENT, 79, 0, 0, sugar2_Torso_mesh_layer_1_mat_override_Metal__CAP__1),
					GEO_OPEN_NODE(),
					...
					GEO_OPEN_NODE(),
						...
						GEO_OPEN_NODE(),
							...
							GEO_OPEN_NODE(),
								GEO_ANIMATED_PART(LAYER_OPAQUE, 7, 18, -10, NULL),
								GEO_OPEN_NODE(),
									GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 5, 0, sugar2_Butt_mesh_layer_1),
									GEO_OPEN_NODE(),
										GEO_DISPLAY_LIST(LAYER_ALPHA, sugar2_Butt_mesh_layer_4),
										GEO_ASM(0, geo_move_mario_part_from_parent),
										GEO_ROTATION_NODE(LAYER_FORCE, 0, 0, 0),
										GEO_OPEN_NODE(),
											GEO_ANIMATED_PART(LAYER_OPAQUE, 79, 0, 0, sugar2_Torso_mesh_layer_1),
											GEO_OPEN_NODE(),
